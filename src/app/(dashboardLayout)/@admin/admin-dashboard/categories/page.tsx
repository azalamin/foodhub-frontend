	...
	return (
		<div className='space-y-10 pb-12 px-2'>
			...
			<div className='flex flex-col md:flex-row md:items-end justify-between gap-6 border-b-2 border-muted pb-8'>
				...
				<div className='bg-emerald-500/10 px-5 py-3 rounded-[2rem] border-2 border-emerald-500/20 flex items-center gap-4'>
			...
			<div className='grid grid-cols-1 xl:grid-cols-12 gap-10'>
				...
				{/* --- LIST SECTION (Scrollable Column) --- */}
