...
// This MUST be a default export and MUST be async (Server Component)
	...
	return (
		<div className='space-y-10 pb-12'>
			<div className='flex flex-col md:flex-row md:items-end justify-between gap-6 border-b-2 border-muted pb-8'>
				...
				<div className='bg-emerald-500/10 px-5 py-2.5 rounded-2xl border-2 border-emerald-500/20 flex items-center gap-3'>
