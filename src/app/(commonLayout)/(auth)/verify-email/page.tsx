	...
	return (
		<div className='min-h-screen bg-muted/30 flex items-center justify-center p-4'>
			<div className='w-full max-w-md bg-background rounded-[3rem] p-10 shadow-2xl text-center space-y-8'>
				...
				<div className='bg-muted/20 p-4 rounded-2xl text-[12px] font-medium text-muted-foreground leading-relaxed'>
					Didn&apos;t see the email? Check your spam folder or try logging in to resend the link.
				</div>
